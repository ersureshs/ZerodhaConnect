...
cwd = os.chdir("D:/AlgoTradingBot/config")
...
def autologin():
    ...
    service = webdriver.chrome.service.Service('D:/chromedriver_win32/chromedriver.exe')
    service.start()
...
if __name__ == '__main__':
    logging.info("Connecting to your broker")
    autologin()    
    ...
    logging.info("Your broker connected successfully")        
